  ...
  return (
    <footer className="py-20 bg-black border-t border-white/5 text-center">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-10 mb-12">
          ...
          <div className="flex flex-col items-center gap-6">
            <h4 className="font-bold text-amber-500 uppercase text-[10px] tracking-[0.3em]">Canais Oficiais</h4>
        ...
        <div className="pt-10 border-t border-white/5">
          ...
          <div className="mt-4 flex justify-center gap-6 text-[9px] text-gray-700 uppercase tracking-widest">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-[60] w-14 h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 active:scale-95 transition-all"
      >
