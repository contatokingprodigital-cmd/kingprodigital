...
const defaultContent: SiteContent = {
  ...
  heroTitle: "MAIS CLIENTES MAIS VENDAS. COM AS ESTRATÉGIAS CERTAS.",
  heroSubtitle: "Sua empresa não precisa de mais seguidores. Precisa de clientes pagando. Chega de investir em marketing que só gera curtidas. Criamos campanhas focadas em faturamento e crescimento previsível.",
